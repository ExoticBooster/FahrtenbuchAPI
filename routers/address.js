...
//create
router.post("/", (req, res) => {
  var sql = "INSERT INTO address (name_shortcut, street, housenumber, zip, location) VALUES (?)";
  let msg;  let object = JSON.parse(JSON.stringify(req.body))
  let data = [object["name_shortcut"], object["street"], object["housenumber"], object["zip"], object["location"]]
